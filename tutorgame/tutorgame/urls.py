...
urlpatterns = [
    ...
    url(r'^ajax/check_homework/(?P<game_id>[\w]+)/$', views.question_check_hw, name='question_hw'),
    url(r'^ajax/question_test/(?P<game_id>[\w]+)/$', views.question_test, name='question_hw'),
    url(r'^ajax/check_test/(?P<game_id>[\w]+)/$', views.question_check_test, name='question_hw'),
